...
class TwigExtension extends AbstractExtension
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            new TwigFunction('query', array($this, 'query')),
            new TwigFunction('crud', array($this, 'crud')),
            new TwigFunction('queryBuilder', array($this, 'queryBuilder')),
            new TwigFunction('qB', array($this, 'qB')),
            new TwigFunction('sql', array($this, 'sql')),
            ...
            new TwigFunction('getLastUpdatedAt', array($this, 'getLastUpdatedAt')),
    ...
    public function collection($coll_name)
    {
        return collection($coll_name);
    }

    public function query($coll_name)
    {
        return query($coll_name);
    }
    ...
    public function crud($coll_name)
    {
        return crud($coll_name);
    }

    public function getKnpTplPath()
    {
        return '@DovStoneSymfonyBlogAdminBundleMoSQLBased/partials/twitter_bootstrap_v4_pagination.html.twig';
    }
    ...
    {
        return $this->please->serve('cache')->getCacheKey($data);
    }
    ...
    public function getLastUpdatedAt(array|string|null $params = null): ?string
    {
        return $this->please->serve('cache')->getLastUpdatedAt($params);
    }
    ...
    {
        $timeService = $this->please->serve('time');
        $seconds = $timeService->humanTime($humanTime);
        $jitterMax = max(0, $timeService->humanTime($maxJitter));
